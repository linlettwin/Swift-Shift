          ...
          <div class="col-md-12">
           ...
           <div class="bottom_work" style="background-color:#E7EEF4;">
                  <div class="header_part d-flex flex-row justify-content-between" style="border-bottom:2px solid black; padding:20px">
                    <h5>Manage Bus Ticket Information</h5>
...
if ($plan_result->num_rows > 0) {
    ...
    if ($seatno_count > 0) {
        ...
        $sql1 = "INSERT INTO btickets VALUES (:btid, :numberofseats, :pid, :seatno, :cid, :bpname, :bpphone, :bdate, :btime, :bcost, :paymethod, :special,:status)";
...
?>
    <table class="table" cellspacing="5px" border="0" id="table_part">
        ...
        <tbody>
            ...
            include 'connect.php';
            $sql = "SELECT COUNT(*) as total FROM btickets GROUP BY bpname, bdate, btime";
            $result = $dbconnection->query($sql);
...
?>
                    ...
                    <tr class="first_row">
                        ...
                        <td class="d-flex flex-row justify-content-center">
                            <form action="admin_bticket.php" method="post" class="d-flex flex-row justify-content-evenly">
        ...
        GROUP BY bpname, bdate, btime";
                        ...
                        <tr class="first_row" >
                                          ...
                                          <td class="d-flex flex-row justify-content-center"> 
                                              <form action="admin_btickets.php" method="post" class="d-flex flex-row justify-content-evenly">
                                              <input type="hidden" value="<?php echo $pid; ?>" name="action_id">
                                              <button type="submit" class="action_btn" name="view_more"><i class="fa-solid fa-eye"></i></button>
                         ...
                         ?>
                          ...
                          if (isset($_POST['search_back'])){
                             echo '<script> window.location("admin_bticket.php")';
                          } 
                        ?>
                          <?php function detail(){?>
                          <table class="table" cellspacing="5px" border="0"  id="table_part">
                    ...
                    GROUP BY bpname, bdate, btime";
                     ...
                     ?>
                         ...
                         <div class="add-on" id="add_info_show">
                             ...
                             <form method="post" action="admin_bticket.php" enctype="multipart/form-data">
                                 ...
                                 <a href="admin_bticket.php" style="text-decoration:none;"><button type="button" class="back-btn" name="search_back"> <<< Back </button><a>
