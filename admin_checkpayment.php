...
if (isset($_POST["dok"])){
  ...
  echo "<script> alert('$text');</script>";
        ...
        $sql_update = "UPDATE btickets SET status = 'disapproved', message='$text' WHERE pid = $one and bdate='$three' and btime = '$two'";
          ...
          <div class="col-md-12">
           ...
           <div class="bottom_work" style="background-color:#E7EEF4;">
                  <div class="header_part d-flex flex-row justify-content-between" style="border-bottom:2px solid black; padding:20px">
                    <h5>Manage Payment Information</h5>
                    <form method="post" action="admin_checkpayment.php">
                ...
                <div class="display-info" id="table_part">
                        <?php
                            if (isset($_POST['addbtn']) || isset($_POST['search_bt']) || (isset($_POST['view_more'])) || (isset($_POST['approve'])) || (isset($_POST['screenshot'])) || (isset($_POST['disapprove'])) )  {
                                ...
                                if (isset($_POST['approve']) ) {
                                  ...
                                  //echo $date;
                                    ...
                                    $time =$_POST['action_id1'];
                                    $date =$_POST['action_id2'];
                                    show_message_part($pid,$time,$date);
...
?>
    <table class="table" cellspacing="5px" border="0" id="table_part">
        ...
        <tbody>
            ...
            $sql = "SELECT pid, bpname, numberofseats, cid, status, screenshot, bcost, bdate, btime, GROUP_CONCAT(seatno) AS seat_no
                    FROM btickets
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $date_timestamp = strtotime($bdate);
...
<!-- <div id="screenshotModal" class="modal">
    ...
    <img class="modal-content" id="modalScreenshot">
                        ...
                        <td>
                        <form action="admin_checkpayment.php" method="post">
                        <input type="hidden" value="<?php echo $pid; ?>" name="action_id">
                        <input type="hidden" value="<?php echo $time; ?>" name="action_id1">
                        <input type="hidden" value="<?php echo $date; ?>" name="action_id2">
                        ...
                        <td class="d-flex flex-row justify-content-center">
                            <form action="admin_checkpayment.php" method="post" class="d-flex flex-row justify-content-evenly">
                                <input type="hidden" value="<?php echo $pid; ?>" name="action_id">
                                <input type="hidden" value="<?php echo $time; ?>" name="action_id1">
                                <input type="hidden" value="<?php echo $date; ?>" name="action_id2">
                      ...
                      <?php function search_show() {  ?>
                           ...
                           <tbody>
                            <?php  include 'connect.php';
                               $search = $_POST['search'];
                               $sql = "SELECT pid,btid, status,screenshot,bcost,bpname, numberofseats, cid, GROUP_CONCAT(seatno) AS seat_no, bdate, btime
        FROM btickets
        WHERE cid LIKE '%$search%' OR seatno LIKE '%$search%' OR bpname LIKE '%$search%' OR bdate LIKE '%$search%'
        GROUP BY bpname, bdate, btime";
      ...
      window.open(imageUrl, '_blank');
                        ...
                        <td class="d-flex flex-row justify-content-center">
                         ...
                         ?>
                          ...
                          if (isset($_POST['search_back'])){
                             echo '<script> window.location("admin_checkpayment.php")';
                          } 
                        ?>
                          <?php function detail(){?>
                          <table class="table" cellspacing="5px" border="0"  id="table_part">
                            ...
                            <tbody>
                               ...
                               include 'connect.php';
                                  ...
                                  $sql = "SELECT bpname, bpphone,bdate,btime, GROUP_CONCAT(seatno) AS seatnos,bcost, special
                    FROM btickets
                    ...
                    GROUP BY bpname, bdate, btime";
                           ...
                           ?>
                            ...
                            <?php function show_message_part($pid,$time,$date) { ?>
                              <form method="post" action="admin_checkpayment.php" >
                               <?php echo "<script> alert('$pid');</script>"; ?>
                               <label for="inputField">Enter a message:</label><br>
                               <input type="text" id="inputField" name="dmessage" required><br>
                               <input type="hidden" id="inputField" name="one" value="<?php echo $pid; ?>" required><br>
                               <input type="hidden" id="inputField" name="two" value="<?php echo $time; ?>"required><br>
                               <input type="hidden" id="inputField" name="three" value="<?php echo $date; ?>"required><br>
