...
if (isset($_FILES["image"]["name"])) {
  ...
  header("Location: paymentwave.php");
...
$_SESSION["payimage"] = htmlspecialchars("images/payment/wave-money.jpg");
     ...
     <div class="section-container">
      <div class="section-with-background">
        ...
        <div class="btns">
            ...
            <form action="paymentwave.php" method="post">
