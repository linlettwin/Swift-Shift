...
if (isset($_SESSION["customer"])) 
{
  ...
  $_SESSION["path"]="cargo_page_1.php";
}
...
function setSelected($fieldName, $fieldValue) 
{
 ...
 if(isset($_POST["cargo1_next"]))
{
  if(isset($_SESSION["cargo_source1"]))
  {
    if($_SESSION["cargo_source1"] != setPost("cargo_source1"))
    {
  ...
  if(isset($_SESSION["cargo_destination1"]))
  {
    if($_SESSION["cargo_destination1"] != setPost("cargo_destination1"))
    {
      unset($_SESSION["weight"]);
      unset($_SESSION["totalamounts"]);
    }
  ...
  $_SESSION["cargo_source1"] = setPost("cargo_source1");
  $_SESSION["cargo_destination1"] = setPost("cargo_destination1");
...
<head>
  ...
  <link rel="stylesheet" href="cargo_page_1.css">
...
<div class="glass-container">
  ...
  <form action="cargo_page_1.php" method="post" class="booking-form">
  <div style="margin-bottom: 10px;">
  <select id="source" name="cargo_source1" required>

      <option value="" disabled selected>From Location</option>
      <option value="Yangon" <?= setSelected('cargo_source1', "Yangon") ?>>Yangon Region</option>
      <option value="Mandalay" <?= setSelected('cargo_source1', "Mandalay") ?>>Mandalay Region</option>
      <option value="Bago" <?= setSelected('cargo_source1', "Bago") ?>>Bago Region</option>
      <option value="Magway" <?= setSelected('cargo_source1', "Magway") ?>>Magway Region</option>
      <option value="Sagaing" <?= setSelected('cargo_source1', "Sagaing") ?>>Sagaing Region</option>
      <option value="Ayeyarwady" <?= setSelected('cargo_source1', "Ayeyarwady") ?>>Ayeyarwady Region</option>
      <option value="Tanintharyi" <?= setSelected('cargo_source1', "Tanintharyi") ?>>Tanintharyi Region</option>
      <option value="Kachin" <?= setSelected('cargo_source1', "Kachin") ?>>Kachin State</option>
      <option value="Karen" <?= setSelected('cargo_source1', "Karen") ?>>Karen State</option>
      <option value="Mon" <?= setSelected('cargo_source1', "Mon") ?>>Mon State</option>
      <option value="Rakhine" <?= setSelected('cargo_source1', "Rakhine") ?>>Rakhine State</option>
      <option value="Shan" <?= setSelected('cargo_source1', "Shan") ?>>Shan State</option>

    </select>
   
    </div>
    <div style="margin-bottom: 10px;">
    <select id="destination" name="cargo_destination1" required>

      <option value="" disabled selected>To Location</option>
      <option value="Yangon" <?= setSelected('cargo_destination1', "Yangon") ?>>Yangon Region</option>
      <option value="Mandalay" <?= setSelected('cargo_destination1', "Mandalay") ?>>Mandalay Region</option>
      <option value="Bago" <?= setSelected('cargo_destination1', "Bago") ?>>Bago Region</option>
      <option value="Magway" <?= setSelected('cargo_destination1', "Magway") ?>>Magway Region</option>
      <option value="Sagaing" <?= setSelected('cargo_destination1', "Sagaing") ?>>Sagaing Region</option>
      <option value="Ayeyarwady" <?= setSelected('cargo_destination1', "Ayeyarwady") ?>>Ayeyarwady Region</option>
      <option value="Tanintharyi" <?= setSelected('cargo_destination1', "Tanintharyi") ?>>Tanintharyi Region</option>
      <option value="Kachin" <?= setSelected('cargo_destination1', "Kachin") ?>>Kachin State</option>
      <option value="Karen" <?= setSelected('cargo_destination1', "Karen") ?>>Karen State</option>
      <option value="Mon" <?= setSelected('cargo_destination1', "Mon") ?>>Mon State</option>
      <option value="Rakhine" <?= setSelected('cargo_destination1', "Rakhine") ?>>Rakhine State</option>
      <option value="Shan" <?= setSelected('cargo_destination1', "Shan") ?>>Shan State</option>

      Add more destination options as needed 
  </select>
    </div>
    
    <button type="submit" style="width:80%; height:40px; color:black;  background-color:#F18D65" name="cargo1_next" onclick="return check1()">Next&gt;</button>
  </form>
</div>
...
function check1() {
    ...
    if (sourceValue.trim() === "" || destinationValue.trim() === "") {
      swal("Please select divisions first.");
      return false;
    } else if (sourceValue === destinationValue) {
      swal("Please select different divisions.");
      return false;
    }else {
        return true;
      }
