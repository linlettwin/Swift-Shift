          ...
          <div class="col-md-12">
           ...
           <div class="bottom_work" style="background-color:#E7EEF4;">
                  <div class="header_part d-flex flex-row justify-content-between" style="border-bottom:2px solid black; padding:20px">
                    <h5>Manage Cargo Service Information</h5>
...
?>
                    ...
                    <tr class="first_row">
                        ...
                        <td class="d-flex flex-row justify-content-center">
                            <form action="admin_cargo_ticket.php" method="post" class="d-flex flex-row justify-content-evenly">
                      ...
                      <?php function search_show() {  ?>
                         ...
                         ?>
                          ...
                          if (isset($_POST['search_back'])){
                             echo '<script> window.location("admin_cargo_ticket.php")';
                          } 
                        ?>
                          <?php function detail(){?>
                          <table class="table" cellspacing="5px" border="0"  id="table_part">
                            ...
                            <tbody>
                                ...
                                FROM get_cargo_service
                                WHERE status = 'approved' and  gdate = '$gdate' AND gtime = '$gtime'";
                                  $result = $dbconnection->query($sql); 
                                  $firstRow = true;
                                        if ($result->num_rows > 0){
                                        while ($row = $result->fetch_assoc()) {
