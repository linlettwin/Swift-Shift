...
try {
    ...
    $stmt->bindParam(':customer', $cid, PDO::PARAM_INT);
    $stmt->execute();
...
<body class="">
  ...
  <div id="video_box">
    <div class="content" >
      <h1 style="font-size:3vw;  z-index:-10px;"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">"Explore & Ship with Ease"</h1>
      <!--p style="font-size:2vw; z-index:-10px;" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">Embark on seamless journeys and hassle-free cargo shipments with Swift Shift. </p1> -->
      <div class="buttons">
